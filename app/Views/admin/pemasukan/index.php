...
<head>
    ...
    <title>Data Pemasukan - Kasir Bangunan</title>
...
<body>
    <!-- ========== SIDEBAR PAKAI PARTIAL (SAMA SEPERTI LAPORAN) ========== -->
    <?= view('admin/partials/sidebar', ['menu' => 'pemasukan']) ?>
    
    <div class="main-content">
        <nav class="top-navbar">
            <div class="page-title"><i class="fas fa-arrow-trend-up me-2"></i> Data Pemasukan</div>
        ...
        <div class="content-area">
            ...
            <div class="card-custom">
                <div class="card-custom-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-list me-2"></i> Daftar Pemasukan</h5>
                    <a href="<?= base_url('admin/pemasukan/create') ?>" class="btn-dark-custom">
                        <i class="fas fa-plus me-2"></i> Tambah Pemasukan
                    </a>
                </div>
                <div class="p-0">
                    <div class="table-responsive">
                        <table class="table-custom" id="tablePemasukan">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode</th>
                            ...
                            <tbody>
                                <?php if(!empty($pemasukan)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('admin/pemasukan/edit/'.$p['id']) ?>" class="btn-edit"><i class="fas fa-edit"></i></a>
                                            <a href="<?= base_url('admin/pemasukan/delete/'.$p['id']) ?>" class="btn-delete" onclick="return confirm('Yakin hapus?')"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
